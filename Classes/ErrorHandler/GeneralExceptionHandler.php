...
class GeneralExceptionHandler extends ProductionExceptionHandler
{
    ...
    /**
     * @var \Netlogix\Nxerrorhandler\ErrorHandler\Component\AbstractComponent[]
     */
    ...
    public function logError(\Throwable $exception, string $context, int $statusCode = 500)
    {
        ...
        foreach ($this->components as $component) {
            $suppressDefaultLogEntries = $suppressDefaultLogEntries || $component->logError($exception, $context, $statusCode);
        }
